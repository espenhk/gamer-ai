"""Assetto Corsa reward configuration and calculator."""
...
class AssettoCorsaRewardConfig:
    """Reward hyperparameters for Assetto Corsa training."""
    ...
    @classmethod
    def from_yaml(cls, path: str) -> "AssettoCorsaRewardConfig":
        with open(path) as f:
...
class AssettoCorsaRewardCalculator:
    """Stateful reward calculator for Assetto Corsa episodes."""

    def __init__(self, config: AssettoCorsaRewardConfig) -> None:
        self._cfg = config
