...
_IRACING_DIMS: list[ObsDim] = [
    ...
    ObsDim("tire_load_fl", 0.1, "Front-left shock deflection (m), tyre-load proxy"),
    ObsDim("tire_load_fr", 0.1, "Front-right shock deflection (m), tyre-load proxy"),
    ObsDim("tire_load_rl", 0.1, "Rear-left shock deflection (m), tyre-load proxy"),
    ObsDim("tire_load_rr", 0.1, "Rear-right shock deflection (m), tyre-load proxy"),
