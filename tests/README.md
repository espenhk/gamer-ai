...
- action formatting renders 3-value TMNF controls with steer direction/percent and suppresses zero-only accel/brake terms, while still truncating long vectors after six entries
