...
- [Framework / shared](#framework--shared)
  ...
  - [test\_new\_best\_logging.py (27) — `_log_new_best_details` + `_print_episode_summary`](#test_new_best_loggingpy-27--_log_new_best_details--_print_episode_summary)
...
### test_new_best_logging.py (27) — `_log_new_best_details` + `_print_episode_summary`
